...
# we can fail immediately if the size of the input isn't exactly 4 elements
# long. Then we can iterate over the collection and check each element's
# validity instead of looping and creating a new variable.
